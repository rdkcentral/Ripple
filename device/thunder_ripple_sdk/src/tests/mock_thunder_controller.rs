...
use crate::{
    client::{
        ...
        // thunder_client::{
        //     //ThunderClient,
        //     // ThunderCallMessage, ThunderMessage, ThunderSubscribeMessage,
...
impl MockThunderController {
    ...
    //     {
    //         let response = handler.call(msg.handler.clone()).await;
    //         if response.is_some() {
    //             mpsc_send_and_log(&msg.handler, response.unwrap(), "OnStatusChange").await;
    //         }
    //     } else {
    //         println!(
