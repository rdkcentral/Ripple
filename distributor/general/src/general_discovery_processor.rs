...
use ripple_sdk::{
    api::distributor::distributor_discovery::DiscoveryRequest,
...
impl DistributorDiscoveryProcessor {
    pub fn new(client: ExtnClient) -> DistributorDiscoveryProcessor {
        DistributorDiscoveryProcessor {
            client,
...
impl ExtnStreamProcessor for DistributorDiscoveryProcessor {
...
#[async_trait]
impl ExtnRequestProcessor for DistributorDiscoveryProcessor {
